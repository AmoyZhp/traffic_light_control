...
from hprl.policy import MultiAgentPolicy, DQN, PPO, ActorCritic
...
def old_build_trainer(
    config: Dict,
    env: MultiAgentEnv,
    models: Dict,
    replay_buffer: MultiAgentReplayBuffer = None,
    ...
    if policy is None:
        ...
        policy, train_fn = build_policy(trainer_type, agents_id, policy_config,
                                        models)
...
def _create_iql(config, models, agents_id):
    ...
    for id_ in agents_id:
        ...
        policies[id_] = MultiAgentEpsilonGreedy(
