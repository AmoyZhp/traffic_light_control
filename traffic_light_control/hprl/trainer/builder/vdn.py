...
def build_vdn_trainer(config: Dict):
    ...
    action_space = env.local_action_space
    state_space = env.local_state_space
    inner_p = VDN(
        agents_id=agents_id,
        acting_nets=model["acting_nets"],
        target_nets=model["target_nets"],
        critic_lr=critic_lr,
